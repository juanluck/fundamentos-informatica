> **ARCHIVO HISTÓRICO.** Copia preservada desde la rama `maqueta-quarto-v01`. No es una especificación vigente. Se conserva por trazabilidad pedagógica; la estructura vigente del Tema 1 está en `design/TEMA1_MACROVERSION_V1.md`.
